...
world_info = {"world_count": 1,
              ...
              "World_0": {"levels": 2, "command": []},
              "World_1": {"levels": 2, "command": []}}
...
def game_menu(lost=False):
    ...
    # Endless
    button(55, 10, language_dictionary["game_menu"][1], lambda: (clear_items(), create_entity(), endless()), state=player.return_tutorial())
